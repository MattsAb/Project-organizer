...
export default function DashboardProject({
  ...
  return (
    <div className="bg-gray-50 dark:bg-slate-800 p-5 rounded-xl flex items-stretch gap-10 mx-10 my-5">
      ...
      <button className="flex flex-col bg-gray-200 hover:bg-gray-300 dark:bg-slate-700 dark:hover:bg-slate-600 flex-2 p-5 rounded-sm justify-around items-center cursor-pointer"
