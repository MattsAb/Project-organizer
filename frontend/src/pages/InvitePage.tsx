...
async function handleInvite (process: string, projectId: number, inviteId: number) {
    ...
    return (
        <div className="flex flex-col items-center w-full">
            ...
            {invites.length > 0 && (
            <div className="dark:bg-slate-800 bg-gray-50 w-1/2 flex flex-col items-center rounded-xl py-5">
                    {invites.map((invite) => (
                        <div className="dark:bg-slate-700 bg-gray-200 px-4 py-4 m-2 w-3/4 rounded-sm flex items-center justify-between text-2xl gap-4" key={invite.id}> 
